  ...
  return (
    <div className="absolute bottom-0 h-[60px] left-0 w-[375px]">
      ...
      >
        ...
        <p
          className={`absolute font-['Noto_Sans_JP:${activeTab === 'timeline' ? 'Bold' : 'Regular'}',sans-serif] ${activeTab === 'timeline' ? 'font-bold' : 'font-normal'} inset-[65%_79.47%_13.33%_4.53%] leading-[13px] text-[${activeTab === 'timeline' ? '#f48522' : '#999999'}] text-[10px] text-center text-nowrap whitespace-pre`}
        >
          タイムライン
        </p>
